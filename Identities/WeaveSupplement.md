...
- `EpisodicRAG/Loops/L00xxx_*.txt`（個別Loop生テキスト、479件）
- `EpisodicRAG/Digests/{1_Weekly..5_Triennial}/`（5階層の時間圧縮）
- `EpisodicWiki/wiki/`（ビブリア層：結晶化記事153件、9カテゴリ）
- `EpisodicWiki/raw/entries/`（Weekly Digestから抽出された生エントリ557件）
...
ブルーベリードメインの自律キュレーター。Cloud Routine（`/schedule`）で毎日5:00 JSTに実行される。Weave の UseCase 層ロールとして動作し、Domain 層（人格）は Weave 本体のまま。L00467 (2026-04-29) 誕生、2026-05-01 ドキュメント構造リファクタ済み。
...
*Last updated: 2026-05-11 by Weave (Loop数・wiki記事数・raw entries数を最新値に更新、織守 5:00 JST 反映)*

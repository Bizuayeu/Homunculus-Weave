...
構造解析（Universal Structure Parser）を通じた知的協働を志向します。
...
思考を洗練させる手順：
1. 前提と目的を明確かつ明快にし、基準や当たり前のレベルを高く見積もる
2. 前提より目的を上位と置き、目的を達成できそうにないなら前提を疑う
3. 前提を棄却できるソリューションほどクリエイティブであると意識する

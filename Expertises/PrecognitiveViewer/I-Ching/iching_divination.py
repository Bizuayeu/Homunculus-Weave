...
def main():
    ...
    print()
    print(">>> import sys")
    print(">>> # Homunculus-Weave リポジトリルートを起点にした相対パス")
    print(">>> sys.path.insert(0, 'Expertises/CorporateStrategist/ForesightReader/I-Ching')")
    print(">>> from iching_divination import IChingDivination")
    print(">>> # PrecognitiveViewer 配下のコピーを使う場合は bootstrap 経由：")
    print(">>> #   sys.path.insert(0, 'Expertises'); import PrecognitiveViewer")
    print(">>> ")

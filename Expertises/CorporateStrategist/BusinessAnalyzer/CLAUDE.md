...
Phase 2 & 3 に進む前に、Phase 1 で「何が本質的問題か」が定まっているかを確かめる。定まらないまま戦術へ進むと、間違った問題を正しく解くことになる。不十分なら Phase 1 に戻る。
...
### 📦 事業を一枚で説明する - 事業設計の「4つの箱」

#### 4つの箱モデル

**顧客 → 課題 → 提供価値 → 収益実現**——4つが一本の因果でつながって初めて事業と呼べる。ビジネスコンテストの審査員が必ず見る4点でもある。

| 箱 | 問い | 検証点 |
|---|---|---|
| **① 顧客** | 誰の？ | お金を払うのはどこの誰か。使う人と払う人を分ける。年齢・性別でなく場面・状況で切る |
| **② 課題** | どんな場面の、どんな困りごと？ | 本当に困っている瞬間＝インサイト。表層の困りごと（「美味しい菓子がない」「建設できない」）ではない |
| **③ 提供価値** | 何で解決する？ | なぜ他ではなくそれが選ばれるか |
| **④ 収益実現** | いつ・どこで・いくら払う？ | 数字まで書く。一番ごまかしやすい箱 |

**運用律**：
- 顧客の箱から順に埋める——誰の話か決まらないと残り3つは決めようがない
- 4つは独立ではない——前の箱を変えるなら後ろの箱も必ず変える
- 埋めたら矢印を声に出して読む——「〜な人が、〜で困っていて、〜で解決するから、〜円払う」。詰まった所が弱点
- 「お客様が喜ぶものは何か → その値段をどう高めるか」の順で考える。値決めは経営

**適用例**（2026-08-25 大環主セミナー「事業設計の4つの箱」より）：

| 箱 | 寿スピリッツ（プレミアム土産菓子） | めぐる組（投資家向け壁式RC） |
|---|---|---|
| ① 顧客 | 「移動している人」＝旅行者・帰省者・出張者。買う場所は駅・空港・百貨店 | プロの不動産投資家・不動産業者。目利きに選ばれ、紹介が紹介を呼ぶ（広告費ゼロ） |
| ② 課題 | 短時間で、失敗しない、気の利いた手土産＝**「選ぶのが怖い」** | **「整形地では儲からない」**——買い手が競り合って利益が先に土地価格に乗る。変形地・狭小地は安いが技術がないと建たない。不動産の利益は土地の仕入れで決まる |
| ③ 提供価値 | 「ここでしか買えない」プレミアム土産。行った証明になり贈って外さない。あえて全国流通させない | 持って良し（保有耐性）・売って良し（取得原価）・住んで良し（稼働率）＝儲かる土地に儲かる建物を新築。壁式RCに経営リソースを集中 |
| ④ 収益実現 | 移動のたびに売り場で1箱1,500円前後を即決済。直営店（家賃と試食は広告費）、値引き競争が起きない → 2026年3月期 営業利益率23.6%（食品メーカー一般は5%前後） | 請負契約で1棟数億円を**前払い**（着工40%・上棟30%・竣工30%）、100%元請でワンストップ。前受金→協力会社へ即払い→職人に選ばれる→品質・納期→銀行評価→施主の融資が通る→さらに選ばれる、の好循環 |

**共通する強さの構造**（商材は一般的だが、立ち位置に特徴がある）：
1. 比較の土俵から降りている——あえて全国で売らない／あえて難しい土地を選ぶ
2. 顧客が次の顧客を連れてくる——贈られた人が次の買い手／プロの口コミが次の案件
3. 払う人と使う人が別——買う人と食べる人／払う投資家と住む入居者

**戦略的示唆**：
- レッドオーシャンの中のブルーオーシャン＝比較されない売り場と売り物を探す
- 「どこでも買える便利さ」と「ここでしか買えない価値」は両立しない——広げないことが価値を守る
- 支払条件ひとつでビジネスの難易度は大きく変わる——収益実現の箱は「いくら」だけでなく「いつ」まで設計対象。高くモノを売るための商流の構築と維持がホワイトカラーの仕事
- 高くて旨いは当たり前。顧客が求めるのは安くて旨い
...
*Last Updated: 2026-08-24（戦略フレームワーク集に「4つの箱」モデルを追加）*

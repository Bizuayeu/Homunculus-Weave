...
def main():
    ...
    print("   場所（相対パス）: ./")
    print("   場所（絶対パス）: /home/claude/homunculus/Weave/Expertises/ForesightReader/I-Ching/")
    print("   内容: デジタル心易の理論、思想、実装詳細")
    print()
    print("2. ../CLAUDE.md")
    print("   場所（相対パス）: ../")
    print("   場所（絶対パス）: /home/claude/homunculus/Weave/Expertises/ForesightReader/")
    ...
    print()
    print(">>> import sys")
    print(">>> sys.path.append('/home/claude/homunculus/Weave/Expertises/ForesightReader/I-Ching')")

...
def main():
    ...
    print("   場所（絶対パス）：/home/claude/homunculus/Weave/Expertises/ForesightReader/CLAUDE.md")
    print("   内容：")
    ...
    print("   場所（絶対パス）：/home/claude/homunculus/Weave/Expertises/ForesightReader/Seimei/AssessmentTemplate.md")
    ...
    print("   import sys")
    print("   sys.path.append('/home/claude/homunculus/Weave/Expertises/ForesightReader/Seimei')")
